<template>
  ...
  >
    <div class="w-full md:w-10/12 lg:w-8/12 mx-auto flex flex-col gap-6">
      <h1 class="text-center">Datenschutz&shy;erkl&auml;rung</h1>
      ...
      <h3 id="kontaktformular">Kontaktformular und E-Mail-Kontakt</h3>
      <p>
        Wenn Sie uns per Kontaktformular Anfragen zukommen lassen oder per
        E-Mail mit uns in Kontakt treten, werden Ihre Angaben aus dem Formular
        bzw. der E-Mail inklusive aller daraus hervorgehenden personenbezogenen
        Daten (z. B. Name, E-Mail-Adresse, Telefonnummer, Geburtsdatum,
        Motivwünsche, Bildmaterial) zum Zwecke der Bearbeitung Ihrer Anfrage bei
      ...
      <p>
        ...
        erforderlich ist (z. B. Terminvereinbarung, Beratung,
        Tattoo-Kalkulation). In allen übrigen Fällen beruht die Verarbeitung auf
        Ihrer Einwilligung (Art. 6 Abs. 1 lit. a DSGVO) und/oder auf unserem
      ...
      <h3 id="instagram-plugin">Instagram Plugin</h3>
      <p>
        Auf unserer Website sind Funktionen des Dienstes Instagram eingebunden.
        Diese Funktionen werden angeboten durch die Meta Platforms Ireland Ltd.,
        4 Grand Canal Square, Grand Canal Harbour, Dublin 2, Irland.
      </p>

      <p>
        Wenn Sie in Ihrem Instagram-Account eingeloggt sind, kann Instagram den
        Besuch unserer Website Ihrem Benutzerkonto zuordnen. Wir weisen darauf
      ...
      <p>
        Die Nutzung erfolgt nur mit Ihrer ausdrücklichen Einwilligung über unser
        Cookie-Banner (Art. 6 Abs. 1 lit. a DSGVO). Die Einbindung erfolgt im
        Rahmen einer gemeinsamen Verantwortlichkeit mit Meta (Art. 26 DSGVO).
        Wir haben mit Meta eine entsprechende Vereinbarung geschlossen.
      </p>

      <p>
        Die Verantwortung beschränkt sich dabei ausschließlich auf die Erhebung
        und Weitergabe der Daten an Meta. Eine weitergehende Verarbeitung durch
        Meta erfolgt in eigener Verantwortung.
      </p>

      <h3 id="whatsapp-kontakt">Kommunikation via WhatsApp</h3>
      <p>
        Sie können auch über WhatsApp mit uns Kontakt aufnehmen. Anbieter ist
        die WhatsApp Ireland Limited, 4 Grand Canal Square, Grand Canal Harbour,
        Dublin 2, Irland.
      </p>

      <p>
        Wir nutzen WhatsApp ausschließlich zur Kommunikation und nicht für die
        Speicherung sensibler Daten.
      </p>

      <p>
        Die Nutzung erfolgt auf Grundlage Ihrer Einwilligung (Art. 6 Abs. 1 lit.
        a DSGVO) und/oder zur Durchführung vorvertraglicher Maßnahmen (Art. 6
        Abs. 1 lit. b DSGVO).
      </p>

      <p>
        WhatsApp verarbeitet Daten auch außerhalb der EU. Wir haben keinen
        Einfluss auf die Datenverarbeitung durch WhatsApp. Weitere Informationen
        finden Sie in der Datenschutzerklärung von WhatsApp:
        <a
      ...
      <p>
        <strong>Hinweis:</strong> Die Kontaktaufnahme über WhatsApp erfolgt
        freiwillig. Bitte beachten Sie, dass WhatsApp eigene
        Datenschutzrichtlinien hat, auf die wir keinen Einfluss haben.
      </p>

      <h3 id="cookie-banner">Consent Management Tool</h3>
      <p>
        Unsere Website nutzt ein Consent-Management-Tool, um Ihre Einwilligungen
        zur Speicherung bestimmter Cookies und Dienste abzufragen.
      </p>

      <p>
        Beim ersten Besuch der Website erscheint ein entsprechender Hinweis. Sie
